...
# May 6, 2026
I don't think that i'm personally helpib=ng trainig AI. i mean i thing that when we scroll and like a video we are giving information abuat what we like, but i also think that if we like a video with more than a million likes we are helping Ai, and i think that becasue we are kind of telling that the video is the interest of so many person, so that way it can be in more for you page # April 9, 2026 
